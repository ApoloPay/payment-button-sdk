...
jQuery(function($) {
    ...
    const componentSelector = 'payment-button'; 
    let component = document.querySelector(componentSelector);
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success && response.data.process_id) {
                        ...
                        if (component) {
                            // 5. Inyectar atributos dinámicamente al Web Component
                            component.setAttribute('process_id', processId);
                            component.setAttribute('public_key', apolo_params.public_key);
                            ...
                            setTimeout(() => {
                                ...
                                // 6. Abrir el modal
                                // Asumimos que el componente abre el modal al hacer click o tiene método open()
                                component.click(); 
